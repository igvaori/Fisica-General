...
\begin{prob}
Una varilla de longitud $L$ y masa $M$ puede girar libremente alrededor de un pivote situado en un extremo $A$ de la misma. Una bala de masa $m$ y velcidad $v$ golpea la varilla a una distancia $\boldsymbol{a}$ de $A$ y se incrusta en ella.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.15\textwidth]{imagenes/imagenes17/T17IM08.png}
	\end{figure}
\end{multicols}
